...
void plot_config(Simulator simulator, bool show = false, std::string run_name = "");
void plot_single_beacon_traj(Simulator simulator, int beacon_id, bool show=false, bool add_legend=false, std::string run_name="");
void plot_uniformity_traj(Simulator simulator, bool show=false, std::string run_name = "");
